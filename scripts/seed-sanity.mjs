...
const homePage = {
  _id: "homePage",
  _type: "homePage",
  seoTitle: "Ryan Judy | Digital Marketing Columbus, OH",
  seoDescription:
    "10+ years of digital marketing expertise — websites, AI, SEM, SEO, and strategy — helping Columbus businesses dominate online.",
  sections: [
    {
      _type: "heroSection",
      _key: "hero",
      badge: "Based in Columbus, OH • Serving businesses across the region",
      headline: "Your Columbus Business Deserves to",
      ...
      proofStats: [
        ...
        { _key: "s2", value: "$2M+", label: "Ad Spend Managed" },
        { _key: "s3", value: "Columbus", label: "OH Based" },
      ],
    },
    {
      _type: "statsSection",
      _key: "stats",
      stats: [
        { _key: "st1", value: "10+", label: "Years in Digital Marketing", description: "Across agencies, in-house, and consulting" },
        { _key: "st2", value: "$2M+", label: "Ad Spend Managed", description: "Across Google, Meta, Bing, and programmatic channels" },
        { _key: "st3", value: "100%", label: "Senior-Level Execution", description: "You work directly with me — no junior handoffs, ever" },
        { _key: "st4", value: "Columbus", label: "OH Based & Focused", description: "I live here, I know these markets, I'm invested in your win" },
      ],
    },
    {
      ...
      services: [
        ...
        { _key: "svc3", icon: "Search", title: "Search Engine Marketing", description: "Strategic paid search campaigns that put your business in front of buyers at exactly the right moment. Every dollar tracked, every campaign optimized.", highlights: ["Google Ads", "Bing Ads", "Remarketing", "Landing pages"], href: "/services#sem", color: "bg-green-50 text-green-600" },
    ...
    },
    {
      ...
      headline: "Deep experience across",
      headlineHighlight: "industries that matter",
      subheadline: "Every industry has its nuances. I've spent over a decade learning the marketing dynamics across multiple verticals — so I bring relevant context from day one.",
      list: [
        { _key: "i1", icon: "Building2", name: "Financial Services", description: "Banks, credit unions, mortgage companies, and fintech startups. I understand compliance-sensitive marketing and trust-based conversion.", wins: ["Lead generation systems", "Compliance-friendly content", "Multi-location SEO"] },
        { _key: "i2", icon: "GraduationCap", name: "Higher Education", description: "Universities, community colleges, and professional training programs. Enrollment marketing, student journey optimization, and brand strategy.", wins: ["Enrollment funnel optimization", "Student recruitment campaigns", "Academic content strategy"] },
        { _key: "i3", icon: "Home", name: "Real Estate", description: "Agents, brokers, developers, and property management companies. High-intent SEM, local SEO, and lead nurturing that actually closes deals.", wins: ["Local SEO dominance", "High-intent PPC", "CRM integration"] },
        { _key: "i4", icon: "Leaf", name: "Clean Tech", description: "Solar, EV, sustainability-focused companies. Mission-driven storytelling paired with demand generation for complex, considered purchases.", wins: ["B2B demand generation", "Thought leadership content", "LinkedIn campaigns"] },
        { _key: "i5", icon: "Rocket", name: "Startups", description: "Early-stage and growth-stage startups that need to move fast and prove traction. Lean, high-impact strategy without enterprise overhead.", wins: ["MVP launch marketing", "Growth hacking", "Investor-ready metrics"] },
      ],
      moreCardHeadline: "Don't see your vertical?",
      moreCardBody: "The fundamentals of great digital marketing apply across all industries. Let's talk about what's possible for your specific business.",
      moreCardCta: "Let's Talk",
    },
    {
      _type: "whySection",
      _key: "why",
      ...
      quote: "\u201cI started this business because I kept seeing Columbus companies underserved by agencies that were too big to care and too busy to listen.\u201d",
      quoteAuthor: "Ryan Judy, Founder",
      reasons: [
        { _key: "r1", icon: "MapPin", title: "Columbus-First Mindset", description: "I live here, I work here, I know Columbus markets. Local knowledge means better strategies, better connections, and a genuine investment in your success." },
    ...
    },
    {
      ...
      headlineHighlight: "real results",
      subheadline: "Every engagement is scoped to your specific business and goals. These packages are a starting framework — your actual plan will be custom-built for you.",
      plans: [
        { _key: "pl1", name: "Starter", tagline: "For businesses ready to get online right", price: "Let's talk", priceNote: "Scoped to your needs", features: ["Custom 5-page website", "Mobile-first design", "Basic on-page SEO", "Google Analytics setup", "Contact form + CRM integration", "1 strategy session / month", "Email support"], ctaText: "Start the Conversation", isPrimary: false, badge: "" },
        { _key: "pl2", name: "Growth", tagline: "For businesses ready to compete and scale", price: "Let's talk", priceNote: "Tailored engagement", features: ["Custom website (up to 10 pages)", "Full SEO campaign", "Google Ads management", "Monthly reporting dashboard", "AI automation audit", "Bi-weekly strategy sessions", "Priority support", "Competitor monitoring"], ctaText: "Get a Growth Plan", isPrimary: true, badge: "Most Popular" },
        { _key: "pl3", name: "Scale", tagline: "For businesses ready to dominate their market", price: "Custom", priceNote: "Enterprise-level scope", features: ["Everything in Growth", "Full digital marketing suite", "AI integration & automation", "Content marketing program", "Social media management", "Dedicated strategy partner", "Weekly sessions", "White-glove onboarding"], ctaText: "Discuss Your Needs", isPrimary: false, badge: "" },
      ],
      footerNote: "All engagements include a free initial consultation and honest scoping. No lock-in contracts — I earn your business every month.",
    },
    {
      _type: "ctaSection",
      _key: "cta",
...
const aboutPage = {
  _id: "aboutPage",
  _type: "aboutPage",
  seoTitle: "About Ryan Judy | Digital Marketing Strategist, Columbus OH",
  seoDescription: "10+ years of digital marketing experience. Based in Columbus, OH.",
  sections: [
    {
    ...
    },
    {
      ...
      storyBadge: "My Story",
      storyHeadline: "Built from",
      storyHeadlineHighlight: "real experience,",
      storyHeadlineLine2: "not theory",
      storyBody: [
        {
          _type: "block",
          _key: "b1",
          ...
          children: [
            {
              _type: "span",
              _key: "s1",
              text: "I started my career in digital marketing over a decade ago — back when \"digital marketing\" was mostly just email blasts and basic SEO. I've grown with the industry through every major shift: social media, mobile-first, content marketing, programmatic advertising, and now AI.",
              marks: [],
            },
          ],
          markDefs: [],
          ...
          children: [
            {
              _type: "span",
              _key: "s2",
              text: "Over the years I've worked across financial services, higher education, real estate, and startups — managing multi-million dollar ad budgets, leading digital strategy, and seeing what actually works for real businesses.",
              marks: [],
            },
          ],
          markDefs: [],
          ...
          children: [
            {
              _type: "span",
              _key: "s3",
              text: "What I noticed over and over again: Columbus businesses were getting underserved. Either they couldn't afford agency prices, or they were paying for strategy they never saw executed, or they were handed off to junior staff who didn't know their market.",
              marks: [],
            },
          ],
          markDefs: [],
          ...
          children: [
            {
              _type: "span",
              _key: "s4",
              text: "So I started Ryan Judy Digital Marketing to fix that. Columbus businesses deserve access to senior-level digital marketing expertise — and that's exactly what I provide.",
              marks: ["strong"],
            },
          ],
          markDefs: [],
    ...
    },
    {
      ...
      _key: "experience",
      badge: "Experience",
      headline: "A decade of",
      headlineHighlight: "getting it done",
      subheadline:
      ...
      expertiseItems: [
        { _key: "e1", icon: "Globe", label: "Web Design & Dev", years: "10+" },
        { _key: "e2", icon: "Search", label: "SEO & Paid Search", years: "10+" },
        { _key: "e3", icon: "BarChart2", label: "Analytics & GA4", years: "8+" },
        { _key: "e4", icon: "Bot", label: "AI & Automation", years: "4+" },
        { _key: "e5", icon: "TrendingUp", label: "Growth Strategy", years: "10+" },
        { _key: "e6", icon: "Users", label: "Brand & Content", years: "8+" },
      ],
      experienceItems: [
        { _key: "ex1", period: "2024 \u2014 Present", role: "Founder", company: "Ryan Judy Digital Marketing", description: "Launched my own consultancy to bring senior-level digital strategy and execution directly to Columbus businesses — cutting out the agency overhead without cutting corners.", highlight: "Active consulting", accentColor: "gold" },
        { _key: "ex2", period: "2020 \u2014 2024", role: "Senior Digital Marketing Strategist", company: "Financial Services", description: "Led cross-channel digital marketing strategy for mid-market and enterprise clients. Managed $2M+ in annual ad spend across paid search, display, and social — driving measurable pipeline growth.", highlight: "$2M+ ad spend managed", accentColor: "blue" },
        { _key: "ex3", period: "2017 \u2014 2020", role: "Digital Marketing Manager", company: "Higher Education", description: "Oversaw digital marketing strategy for enrollment and advancement at a major Ohio university. Built data-driven campaigns that delivered measurable increases in prospective student engagement.", highlight: "Enrollment & brand campaigns", accentColor: "gray" },
        { _key: "ex4", period: "2014 \u2014 2017", role: "Digital Marketing Specialist", company: "Real Estate", description: "Developed and executed digital campaigns for a growing real estate firm — specializing in local SEO, paid search, and social media to build the brand's online presence from the ground up.", highlight: "Local SEO & paid search", accentColor: "gray" },
      ],
    },
    {
      _type: "valuesSection",
