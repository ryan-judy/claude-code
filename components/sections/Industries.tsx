import { Building2, GraduationCap, Home, Leaf, Rocket, CheckCircle2 } from "lucide-react";
...
const industries = [
  {
    ...
    description:
      "Banks, credit unions, mortgage companies, and fintech startups. I understand compliance-sensitive marketing and trust-based conversion.",
    wins: ["Lead generation systems", "Compliance-friendly content", "Multi-location SEO"],
  },
  {
    icon: GraduationCap,
    name: "Higher Education",
    description:
      "Universities, community colleges, and professional training programs. Enrollment marketing, student journey optimization, and brand strategy.",
    wins: ["Enrollment funnel optimization", "Student recruitment campaigns", "Academic content strategy"],
  },
  {
    icon: Home,
    name: "Real Estate",
    description:
      "Agents, brokers, developers, and property management companies. High-intent SEM, local SEO, and lead nurturing that actually closes deals.",
    wins: ["Local SEO dominance", "High-intent PPC", "CRM integration"],
  },
  {
    icon: Leaf,
    name: "Clean Tech",
    description:
      "Solar, EV, sustainability-focused companies. Mission-driven storytelling paired with demand generation for complex, considered purchases.",
    wins: ["B2B demand generation", "Thought leadership content", "LinkedIn campaigns"],
  },
  {
    icon: Rocket,
    name: "Startups",
    description:
      "Early-stage and growth-stage startups that need to move fast and prove traction. Lean, high-impact strategy without enterprise overhead.",
    wins: ["MVP launch marketing", "Growth hacking", "Investor-ready metrics"],
  },
];
          ...
          <div className="bg-gradient-to-br from-[#1D4ED8] to-[#3B82F6] rounded-2xl p-6 flex flex-col justify-between text-white">
            <div>
              ...
              <p className="text-white/80 text-sm leading-relaxed">
                The fundamentals of great digital marketing apply across all
                industries. Let&apos;s talk about what&apos;s possible for your specific
                business.
              </p>
            </div>
            <a
